    ...
    return(
        <footer className="bottom-0 left-0 z-20 p-4 w-full border-t shadow flex items-center justify-between flex-col md:flex-row bg-stone-800 border-gray-600">
            ...
            <div className="space-x-2">
                ...
                <a href={"https://www.linkedin.com/company/memorial-university-engineering-society/"} target='_blank' className="bg-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded hover:animate-pulse">
