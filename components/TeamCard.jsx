		...
		<div className='flex flex-col ml-5 mr-5 place-items-center rounded-2xl borde drop-shadow-2xl '>
    		    ...
    		    <div className='flex flex-col place-items-center bg-stone-400 min-h-[370px] rounded-b-2xl min-w-full'>
    		        ...
    		        <div className='flex justify-center gap-x-3 p-5'>
    		            ...
    		            {props.facebook ?
    		                <a href={props.facebook} className="p-2 bg-blue-800 font-semibold text-white inline-flex items-center space-x-2 rounded hover:animate-pulse">
    		                    <svg className="w-5 h-5 fill-current" role="img" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
    		            ...
    		            {props.twitter ?
    		                <a href={props.twitter} className="p-2 bg-blue-400 font-semibold text-white inline-flex items-center space-x-2 rounded hover:animate-pulse">
						...
						{props.discord ?
    		                <a href={props.discord} className="p-2 bg-[#7289da] font-semibold text-white inline-flex items-center space-x-2 rounded hover:animate-pulse">
    		                    <svg className="w-5 h-5 fill-current" role="img" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
