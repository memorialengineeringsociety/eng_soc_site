	...
	return (
		<div id="disciplines" className="reveal grid grid-cols-3 gap-x-3 gap-y-3 overflow-hidden p-4 lg:flex">
			<a id="mechanical" className="fade-ins flex col-span-3 h-40 flex-col place-items-center justify-center space-y-2 rounded-2xl border-4 border-black bg-purple-700 opacity-0 transition-transform hover:scale-105 hover:shadow-lg hover:brightness-105 lg:w-1/7">
				...
				<h1 className="pointer-events-none text-center font-gold text-white xl:text-xl 2xl:text-3xl">Engineering One</h1>
			</a>
			...
			<a id="mechatronics" className="fade-ins flex h-40 flex-col place-items-center justify-center space-y-2 rounded-2xl border-4 border-black bg-blue-500  opacity-0 transition-transform hover:scale-105 hover:shadow-lg hover:brightness-105 lg:w-1/7">
				...
				<h1 className="md:text-md pointer-events-none font-gold text-sm text-white xl:text-xl 2xl:text-3xl">Mechatronics</h1>
			</a>
			...
			<a id="ocean-naval" className="fade-ins flex h-40 flex-col place-items-center justify-center space-y-2 rounded-2xl border-4 border-black bg-green-600 opacity-0 transition-transform hover:scale-105 hover:shadow-lg hover:brightness-105 lg:w-1/7">
				...
				<h1 className="pointer-events-none text-center font-gold text-white xl:text-xl 2xl:text-3xl">Ocean Naval</h1>
			</a>
			<a id="process" className="fade-ins col-start-2 flex h-40 flex-col place-items-center justify-center space-y-2 rounded-2xl border-4 border-black bg-pink-500 opacity-0 transition-transform hover:scale-105 hover:shadow-lg hover:brightness-105 lg:col-start-auto lg:w-1/7">
				...
				<h1 className="pointer-events-none font-gold text-white xl:text-xl 2xl:text-3xl">Process</h1>
			</a>
		</div>
	);
};
