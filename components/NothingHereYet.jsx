export function NothingHereYet(props) {
	return (
        <div className='flex flex-col items-center justify-center w-full h-full mt-20 '>
            <div className='bg-white rounded-3xl border-4 border-soc-red p-5'>
                <h1 className='text-2xl lg:text-4xl font-bold text-soc-red text-center'>Nothing here yet!</h1>
