export function MemberCard(props) {
	return (
        <div className="rounded-3xl p-3 bg-stone-400 border-4 border-soc-red">
            <div className="flex flex-col place-items-center xl:flex-row xl:justify-evenly gap-5">
                ...
                <div className="flex flex-col justify-evenly w-3/4">
                    ...
                    <div className='flex justify-center gap-x-3 lg:p-5 rounded-full'>
                        {props.link ? 
                            <a href={props.link} target='_blank' className="bg-stone-300 lg:p-2 font-semibold text-black inline-flex items-center space-x-2 rounded hover:animate-pulse">
                        ...
                        {props.contact ?
							<a href={`mailto:${props.contact}`} target='_blank' className="lg:p-2 bg-black font-semibold text-white inline-flex items-center space-x-2 rounded hover:animate-pulse">
                        ...
                        {props.linkedin ?
                            <a href={props.linkedin} target='_blank' className="bg-blue-600 lg:p-2 font-semibold text-white inline-flex items-center space-x-2 rounded hover:animate-pulse">
