		...
		<div className="rounded-3xl border-4 border-mun-burgundy bg-stone-400 p-3">
			<div className="flex flex-col place-items-center gap-5 xl:flex-row xl:justify-evenly">
				...
				<div className="flex w-3/4 flex-col justify-evenly">
					<h1 className="text-center font-ops text-2xl font-bold text-black md:text-4xl">{props.title}</h1>
					<h1 className="text-center font-gold_bold text-3xl text-white md:text-5xl">{props.name}</h1>
					<h1 className="text-center font-gold text-lg text-black md:text-2xl">{props.program}</h1>
