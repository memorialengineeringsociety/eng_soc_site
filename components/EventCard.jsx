		...
		(
			<div className="flex flex-col justify-center rounded-3xl bg-stone-400 p-5 lg:flex-row">
				...
				<div className="flex w-full flex-col justify-center">
					...
					<h1 className="text-center font-gold_bold text-3xl lg:text-5xl">{props.name}</h1>
					<h2 className="text-center font-ops text-lg text-stone-600 lg:text-2xl">{props.alt_name ? `${props.age} • ${props.alt_name} • ${props.date}` : `${props.age} • ${props.date}`}</h2>
					<h3 className="text-md text-center font-ops text-stone-700 lg:text-xl">
