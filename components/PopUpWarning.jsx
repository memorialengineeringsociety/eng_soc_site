...
const PopupWarning = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full h-full bg-black backdrop-blur-xl bg-opacity-50 flex justify-center items-center transition-opacity ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`} style={{ transition: 'opacity 0.5s ease-out' }}>
