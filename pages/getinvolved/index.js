				...
				<div className={`transition-opacity flex justify-center ${currentButton === 3 ? "block opacity-100" : "hidden opacity-0"} delay-200`}>
					<div className="w-1/2 min-h-screen pt-20">
						...
						<div className="flex justify-center pt-5 pb-5 gap-x-10">
							<button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition" onClick={() => window.open("https://docs.google.com/forms/d/e/1FAIpQLSd6bapES16a9c40zQUhLsR4OoZJD2FBJ_PfZA6cje3WJosRXw/viewform", "_blank")}>
								Volunteer Request Form
							</button>
							<button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition" onClick={() => window.open("https://docs.google.com/forms/d/e/1FAIpQLSeneWqIDHKuxzMUeHK9Zz7jpy0DBfJN4ZwlPBustCRZR1b1-A/viewform", "_blank")}>
