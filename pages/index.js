	...
	return (
		<main className='flex flex-col place-items-center'>
			<div className=" flex space-x-10 p-10 w-3/4">
				<p className="text-2xl text-justify text-gray-500">The Engineering Undergraduate Society is proud to represent over 1,200 engineering students across 7 different disciplines. Every engineering student at the Memorial University is a member of the Engineering Undergraduate society. Being entirely student-run, the Engineering Student Society continually strives to make your time at MUN the best it can be.</p>
			</div>
