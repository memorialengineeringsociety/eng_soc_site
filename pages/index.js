				...
				<div className="flex flex-col md:flex-row justify-between">
					<div className="flex justify-center">
						<img
							...
							className="rounded-full w-1/2 md:w-auto md:h-4/5 p-5 md:p-20"
						/>
					</div>
					<div className="space-y-5 md:space-y-10 p-10 md:mt-10">
						<h1 className="text-white font-gold text-3xl xl:text-5xl 2xl:text-7xl text-center md:text-right">
							1200+ Students
						</h1>
						<h1 className="text-white font-gold text-3xl xl:text-5xl 2xl:text-7xl text-center md:text-right">
							20+ Groups
						...
						<h1 className="text-white font-gold_bold text-4xl w-auto xl:text-6xl 2xl:text-8xl text-center md:text-right">
							1 Community
						</h1>
					</div>
				</div>
