	...
	return (
		<main className="bg-gradient-to-b from-blue-400 to-blue-950">
			<section className="pt-5 flex flex-col justify-center">
				<img src="../res/logos/soc_round_logo.png" className="h-24 lg:h-48 mx-auto rounded-full" />
			...
			<section className="flex flex-col gap-y-3 place-items-center p-3 min-h-screen">
				...
				<LinkCard title="Fall 2023 D-Day Mug Design Contest" description="" link="https://docs.google.com/forms/d/1KYdXAvXpR7TomDo688FYIBlB7JL8OcRqObAH4NAUZ0M/edit" image="" />
