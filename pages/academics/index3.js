	...
	return (
        <main className='flex flex-col'>
            <div className='hidden xl:flex w-full justify-evenly'>
				<a className='w-1/3 flex justify-center p-5'><h1 className='text-black text-3xl font-extrabold underline font-ops'>Co-op</h1></a>
				<a className='w-1/3 flex justify-center p-5'><h1 className='text-black text-3xl font-extrabold underline font-ops'>Support</h1></a>
				<a className='w-1/3 flex justify-center p-5'><h1 className='text-black text-3xl font-extrabold underline font-ops'>Equity, Diversity, and Inclusion</h1></a>
			</div>
            <div className='xl:flex overflow-auto snap-mandatory snap-x'>
                <section id='coop' className="min-w-full snap-center">
                ...
                <section id='edi' className="min-w-full snap-center">
                    <div className="bg-gray-100 p-6">
