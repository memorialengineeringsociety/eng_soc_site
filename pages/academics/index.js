...
function Navigation() {
	...
	return (
		<div className="items-center xl:flex xl:flex-col">
			<div className="sticky top-[76px] z-40 flex w-full flex-col justify-evenly rounded-b-3xl border-b-2 border-black bg-stone-400 pb-5 pl-20 pr-20 pt-3 lg:flex-row xl:top-[92px]">
				<button className={`font-ops font-extrabold transition-transform xl:w-1/3 xl:text-3xl ${currentButton === 1 ? "text-black underline xl:scale-125" : "text-white"}`} onClick={() => setCurrentButton(1)}>
					Co-op
				</button>
				<button className={`font-ops font-extrabold transition-transform xl:w-1/3 xl:text-3xl ${currentButton === 2 ? "text-black underline xl:scale-125" : "text-white"}`} onClick={() => setCurrentButton(2)}>
					Support
				</button>
				<button className={`font-ops font-extrabold transition-transform xl:w-1/3 xl:text-3xl ${currentButton === 3 ? "text-black underline xl:scale-125" : "text-white"}`} onClick={() => setCurrentButton(3)}>
